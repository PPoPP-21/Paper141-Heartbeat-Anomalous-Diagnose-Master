...
For better understanding of our framework proposed, this project creates a folder for each benchmark application. In this folder, there are two folds i.e., training and testing. In addition, the data sets used in this article are all in the Datasets folder.
